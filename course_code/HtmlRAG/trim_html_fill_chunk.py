...
if __name__ == "__main__":
    ...
    argparser.add_argument("--mini_dataset", default=True, action="store_true")
    ...
    def fill_chunk(context_window, dataset):
        input_file = f"./html_data/{dataset}/chunk_rerank/{rerank_model}-{dataset}-{split}.jsonl"
        output_dir = f"./html_data/{dataset}/chunk_rerank/{chat_tokenizer_name}"
        output_file = f"{output_dir}/{rerank_model}-{dataset}-{split}-{context_window}.jsonl"
